...
AI Studio의 첫 번째 프로덕션은 뉴스 수집기다. AI는 트렌드에 참 민감한 분야인 것 같다. 6개월 전, 3개월 전 소식은 이미 너무 옛날의 이야기다. 국내 유튜브 채널 중 노정석 대표님 채널을 정말 좋아한다. 가장 인사이트 있다고 생각한다. 이 외에도 해커뉴스나 AI타임즈, 또 연구 논문들까지 트래킹할 수 있으면 제작 방식에 큰 인사이트를 줄 수 있을 것이라 생각했다.
